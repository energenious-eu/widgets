...
const WidgetOptionsStory = (props) => {
  ...
  const options = {
    ...
    singleton: boolean('singleton', false, optionsGroup),
    setCookie: boolean('setCookie', false, optionsGroup),
    setCookieDomain: text('setCookieDomain', '', optionsGroup),
    loadScriptAJAX: boolean('loadScriptAJAX', false, optionsGroup),
    tokenName: text('tokenName', 'token', optionsGroup),
    className: text('className', '', optionsGroup),
    scope: text('scope', '', optionsGroup),
  };
